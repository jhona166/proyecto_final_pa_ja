...
public class Vehiculo {
	...
	public Vehiculo(String placa, String modelo, String marca, Integer anioFabricion, String paisFabricion,
			String cilindraje, BigDecimal precio, BigDecimal valorDia, String disponibilidad) {
		super();
		this.placa = placa;
		this.modelo = modelo;
		this.marca = marca;
